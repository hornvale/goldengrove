...
import { buildPeakMaterial, buildTreeMaterial, buildWaveMaterial, hash01 } from './sprites';

// Re-exported so existing callers/tests (`./symbolLayer.test.ts`) importing
// `hash01` from this module keep working after the shared builders moved to
// `./sprites`.
export { hash01 };
