 ...
 * [0,1)`, afternoon-peaked, damped by thermal inertia, and zero when the sun
 * never rises (polar night). Mirrors `diurnal_waveform`
...
export function diurnalWaveform(
  ...
  return aGeo * inertia * Math.cos(TAU * (dayFraction - PEAK_FRAC));
}
